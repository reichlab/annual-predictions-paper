...
\begin{align}
    ...
    % \log \Big [ \mathbf{E}(Y_{i,t}) \Big ] = \log \Big [ \mathbf{E}(n_{i,t}\lambda_{i,t}) \Big ] &= \log(n_{i,t}) + \alpha_i + \sum_{j=1}^J g_j(x_{j,i,t}|\boldsymbol{\theta}), \label{eqn:regression} \\
...
The code and data for this analysis is publicly available at \url{https://doi.org/10.5281/zenodo.546123}.
